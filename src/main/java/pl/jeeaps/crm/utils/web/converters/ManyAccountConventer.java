 ...
 */
@Named("multiAccountConvener")
public class ManyAccountConventer implements Converter {

    @Inject AccountSessionEJB accountSession;
    
    @Override
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        accountSession.addSelectedAccount(Long.valueOf(value));
        return accountSession.getSelectedAccounts();
    }
